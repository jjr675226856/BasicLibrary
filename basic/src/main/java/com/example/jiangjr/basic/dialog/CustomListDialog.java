...
//        super(new ContextThemeWrapper(_builder.mContext, R.style.Dialogs_Light));
        super(_builder.mContext);
        // Set correct properties.
        this.mContext = _builder.mContext;
        this.mTheme = Theme.DARK;//_builder.mIsDark ? Theme.DARK : Theme.LIGHT;
...
//        mRootView.getBackground().setAlpha(0);
        ...
        mListView.setAdapter((ListAdapter) mCustomListAdapter);
    ...
    public static class Builder {
        ...
        private Alignment mTitleAlignment = Alignment.RIGHT, mItemAlignment = Alignment.RIGHT;
